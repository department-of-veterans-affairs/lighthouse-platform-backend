  ...
  factory :consumer do
    ...
    trait :with_apis do
      after(:create) do |consumer, _|
        ...
        consumer.consumer_api_assignments << FactoryBot.create(:consumer_api_assignment, consumer: consumer, api_environment: api_env_one)
        consumer.consumer_api_assignments << FactoryBot.create(:consumer_api_assignment, consumer: consumer, api_environment: api_env_two)
