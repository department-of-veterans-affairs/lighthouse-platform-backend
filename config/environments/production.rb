...
Rails.application.configure do
  ...
  # config.asset_host = 'https://https://charleystran.ngrok.io/platform-backend'
  ...
  config.active_job.queue_adapter = :sidekiq # migrate to :sidekiq before using consumer generated background jobs
